...
if( ! function_exists( 'wp_shake_js' ) && strpos( $_SERVER['REQUEST_URI'], '/wp-login.php') !== 0 ){
...
if( ! function_exists( 'wp_login_viewport_meta' ) && strpos( $_SERVER['REQUEST_URI'], '/wp-login.php') !== 0 ){
...
if( ! function_exists( 'retrieve_password' ) && strpos( $_SERVER['REQUEST_URI'], '/wp-login.php') !== 0 ){
